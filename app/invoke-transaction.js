...
const invokeChaincode = async function(peerNames, channelName, chaincodeName, fcn, args, username, org_name) {
	...
	try {
		...
		console.log("request at Invoke trans ==> ",request)
		...
		if (all_good) {
			...
			const sendPromise = channel.sendTransaction(orderer_request,60000);
	...
	let message = util.format(
		'From the channel \'%s\' and your transaction ID: %s',
